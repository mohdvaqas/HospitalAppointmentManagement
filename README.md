...
AppointmentController | DELETE | appointment/delete?appointmentId=2 | BLANK | BLANK                                                                                                                                                                                                 | curl --location 'http://localhost:9999/proxy-appointment/appointment' \--header 'Content-Type: application/json' \--data '{"patientId": 1,"appointmentDateTime": "2023-06-09 12:12:12"}'
